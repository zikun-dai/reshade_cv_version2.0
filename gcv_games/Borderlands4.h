...
class GameBorderlands4 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Boaderlands4"; }
...
REGISTER_GAME_INTERFACE(GameBorderlands4, 0, "borderlands4.exe");
