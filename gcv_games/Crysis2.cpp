...
uint64_t GameCrysis2::camera_dll_mem_start() const { return 0x25AA550ull; } //unused, assign offset before reading
GameCamDLLMatrixType GameCrysis2::camera_dll_matrix_format() const { return GameCamDLLMatrix_3x4; }
...
#define FAR_PLANE_DISTANCE 8000.0
...
bool GameCrysis2::get_camera_matrix(CamMatrixData& rcam, std::string& errstr) {
	...
	float cambuf[12] = {};
	const uint64_t cam_matrix_offset = 0x25AA550ull;
