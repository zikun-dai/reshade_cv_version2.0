...
class GameCrysis3 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Crysis3"; }
...
REGISTER_GAME_INTERFACE(GameCrysis3, 0, "crysis3remastered.exe");
