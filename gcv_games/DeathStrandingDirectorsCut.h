...
class GameDeathStrandingDirectorsCut : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "DeathStrandingDirectorsCut"; }
...
REGISTER_GAME_INTERFACE(GameDeathStrandingDirectorsCut, 0, "ds.exe");
