...
std::string GameDevilMayCry5::gamename_verbose() const { return "DevilGameDevilMayCry5"; } // hopefully continues to work with future patches via the mod lua
    ...
    float fov)
{
    ...
    const float pose_scale = 0.5f; // 脚本中 pose_scale = 0.5
    const float t_cv[3] = {
