...
class GameDevilMayCry5 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "DevilMayCry5"; }
...
REGISTER_GAME_INTERFACE(GameDevilMayCry5, 0, "devilmaycry5.exe");
