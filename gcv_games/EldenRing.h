...
class GameEldenRing : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "EldenRing"; }
...
REGISTER_GAME_INTERFACE(GameEldenRing, 0, "eldenring.exe");
