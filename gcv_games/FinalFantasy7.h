...
class GameFinalFantasy7 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "FinalFantasy7"; }
...
REGISTER_GAME_INTERFACE(GameFinalFantasy7, 0, "ff7remake_.exe");
