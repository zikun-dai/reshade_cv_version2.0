...
class GameGhostrunner : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Ghostrunner"; }
...
REGISTER_GAME_INTERFACE(GameGhostrunner, 0, "ghostrunner-win64-shipping.exe");
