...
class GameGhostrunner2 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Ghostrunner2"; }
...
REGISTER_GAME_INTERFACE(GameGhostrunner2, 0, "ghostrunner2-win64-shipping.exe");
