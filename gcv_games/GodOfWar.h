...
class GameGodOfWar : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "GodOfWar"; }
...
REGISTER_GAME_INTERFACE(GameGodOfWar, 0, "gow.exe");
