...
class GameGodofWar5_CE : public GameWithCameraDataInOneDLL {
protected:
	...
	bool overwrite_extrinsic_from_memory(CamMatrixData& rcam, std::string& errstr) const;
public:
	virtual std::string gamename_simpler() const override { return "GodofWar5_CE"; }
...
REGISTER_GAME_INTERFACE(GameGodofWar5_CE, 0, "gowr.exe");
