...
class GameHellblade : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Hellblade"; }
...
REGISTER_GAME_INTERFACE(GameHellblade, 0, "hellbladegame-win64-shipping.exe");
