...
class GameHi_Fi_RUSH : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Hi-Fi-RUSH"; }
...
REGISTER_GAME_INTERFACE(GameHi_Fi_RUSH, 0, "hi-fi-rush.exe");
