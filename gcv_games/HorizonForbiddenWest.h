...
class GameHorizonForbiddenWest : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "HorizonForbiddenWest"; }
...
REGISTER_GAME_INTERFACE(GameHorizonForbiddenWest, 0, "horizonforbiddenwest.exe");
