...
class GameImmortalsFenyxRising : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "ImmortalsFenyxRising"; }
...
REGISTER_GAME_INTERFACE(GameImmortalsFenyxRising, 0, "immortalsfenyxrising.exe");
