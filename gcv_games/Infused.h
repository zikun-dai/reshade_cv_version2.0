...
class GameInfused : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Infused"; }
...
REGISTER_GAME_INTERFACE(GameInfused, 0, "infused-win64-shipping.exe");
