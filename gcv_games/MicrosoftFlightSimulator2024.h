...
class GameMicrosoftFlightSimulator2024 : public GameWithCameraDataInOneDLL {
   protected:
   ...
   public:
    virtual std::string gamename_simpler() const override { return "MicrosoftFlightSimulator2024"; }
...
REGISTER_GAME_INTERFACE(GameMicrosoftFlightSimulator2024, 0, "flightsimulator.exe");