...
class GameMilesMorales : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "MilesMorales"; }
...
REGISTER_GAME_INTERFACE(GameMilesMorales, 0, "milesmorales.exe");
