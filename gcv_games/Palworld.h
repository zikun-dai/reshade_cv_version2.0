...
class GamePalworld : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Palworld"; }
...
REGISTER_GAME_INTERFACE(GamePalworld, 0, "palworld-win64-shipping.exe");
