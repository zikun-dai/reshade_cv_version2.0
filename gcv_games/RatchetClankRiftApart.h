...
class GameRatchetClankRiftApart : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "RatchetClankRiftApart"; }
...
REGISTER_GAME_INTERFACE(GameRatchetClankRiftApart, 0, "riftapart.exe");
