...
class GameReadyOrNot : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "ReadyOrNot"; }
...
REGISTER_GAME_INTERFACE(GameReadyOrNot, 0, "readyornotsteam-win64-shipping.exe");
