...
class ResidentEvil8 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "ResidentEvil8"; }
...
REGISTER_GAME_INTERFACE(ResidentEvil8, 0, "re8.exe");
