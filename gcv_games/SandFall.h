...
class GameSandFall : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "SandFall"; }
...
REGISTER_GAME_INTERFACE(GameSandFall, 0, "sandfall-win64-shipping.exe");
