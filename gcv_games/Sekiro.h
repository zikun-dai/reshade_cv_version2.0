...
class GameSekiro : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Sekiro"; }
...
REGISTER_GAME_INTERFACE(GameSekiro, 0, "sekiro.exe");
