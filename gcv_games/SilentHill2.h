...
class GameSilentHill2 : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "SilentHill2"; }
...
REGISTER_GAME_INTERFACE(GameSilentHill2, 0, "shproto-win64-shipping.exe");
