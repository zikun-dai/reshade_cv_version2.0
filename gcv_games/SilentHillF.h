...
class GameSilentHillF : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "SilentHillF"; }
...
REGISTER_GAME_INTERFACE(GameSilentHillF, 0, "shf-win64-shipping.exe");
